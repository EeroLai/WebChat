<template>
    ...
    <div class="flex-1 flex flex-col min-h-screen h-screen">
        <div class="flex text-white h-12">
            <div
                class="bg-gray-800 w-56 flex-none flex items-center justify-between border-b border-gray-900 px-3 py-2">
            ...
            <div class="flex-1 bg-gray-750 flex items-center justify-between border-b border-gray-900 px-4">
                <div class="flex items-center">
                    ...
                    <div class="border-l pl-3 ml-3 border-gray-600 text-xs text-gray-400">general discussion of
                        Tailwind CSS</div>
                </div>
                <div class="flex items-center">
                    <a href="#" class="ml-4">
                        <svg class="w-6 h-6 text-gray-500 hover:text-gray-200" fill="currentColor" width="24"
                    ...
                    <a href="#" class="ml-4">
                        <svg class="w-6 h-6 text-gray-500 hover:text-gray-200" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="#" class="ml-4">
                        <form action="#" class="relative">
                            ...
                            <span class="absolute right-0 top-0 mr-1" style="top:6px">
                                <svg class="w-4 h-4 text-gray-500 hover:text-gray-200" fill="currentColor"
                ...
                <div class="bg-gray-850 px-3 py-2 flex items-center justify-between">
                    ...
                    <div class="flex items-center text-gray-500">
                        <a href="#" class="hover:text-white">
                            <svg class="w-5 h-5" fill="currentColor" xmlns="http://www.w3.org/2000/svg" width="24"
                                height="24" viewBox="0 0 24 24">
                                <path
                ...
                <div class="bg-gray-750 flex-1 flex flex-col justify-between">
                    <div class="chat text-sm text-gray-400 overflow-y-auto">
                        <div class="flex mx-6 my-3 py-4 border-t border-gray-700">
                            <div class="flex-none"><a href="#"><img src="/avatar.jpg" alt="avatar"
                                        class="w-10 h-10 rounded-full"></a></div>
                            <div class="ml-5">
                                <div>
                        ...
                        <div class="flex mx-6 my-3 py-4 border-t border-gray-700">
                            ...
                            <div class="ml-5">
                                ...
                                <div>
                                    <div>Here are the <a href="#" class="text-blue-400 hover:underline">Tailwind
                                            docs</a></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex mx-6 my-3 py-4 border-t border-gray-700">
                            ...
                            <div class="ml-5">
                                ...
                                <div>
                                    <div>Exactly the same way as in Vue <a href="#"
                                            class="text-indigo-400 hover:underline">@impulse</a></div>
                                </div>
                            </div>
                        </div>
                        <div class="flex mx-6 my-3 py-4 border-t border-gray-700">
                            ...
                            <div class="ml-5">
                                ...
                                <div>
                                    <div>I think it can slow down the page if there's too much bloat in the
                                        document.</div>
                        ...
                        <div class="flex mx-6 my-3 py-4 border-t border-gray-700">
                            ...
                            <div class="ml-5">
                                ...
                                <div>
                                    <div>Comparison would be better if it's not also comparing an vector svg to a
                                        raster gif, it's a difference in rendering too.</div>
                                </div>
                            </div>
                        </div>
                        <div class="flex mx-6 my-3 py-4 border-t border-gray-700">
                            ...
                            <div class="ml-5">
                                ...
                                <div>
                                    <div>Thank you that works perfectly! Turns out my z-index (or lack of setting
                                        one) was also messing things up on the navbar.</div>
                                </div>
                            </div>
                        </div>
                        <div class="flex mx-6 my-3 py-4 border-t border-gray-700">
                    ...
                    <div class="bg-gray-750 h-24 flex items-center mx-3 border-t border-gray-600">
                        <button
                            class="px-2 py-2 h-10 bg-gray-700 rounded-l text-gray-500 hover:text-white border-r border-gray-600">
                        ...
                        <div class="flex-1">
                            <input type="text"
                                class="w-full text-sm h-10 px-2 py-2 bg-gray-700 text-gray-200 focus:outline-none">
                        </div>
                        <div class="px-2 py-2 bg-gray-700 rounded-r flex items-center h-10">
                            ...
                            <button class="h-10 bg-gray-700 rounded-l text-gray-500 hover:text-white ml-3">
                                <svg class="w-8 h-8" fill="currentColor" width="24" height="24" viewBox="0 0 24 24">
                                    <defs>
                ...
                <div class="sidebar-users text-sm bg-gray-800 w-56 flex-none px-3 py-3 overflow-y-auto">
                    ...
                    <ul class="mb-6 truncate">
                        <li class="text-gray-500 px-2 hover:text-gray-200 hover:bg-gray-750 py-1 my-2">
                            <a href="#" class="flex items-center">
                                <span class="flex-none"><a href="#"><img src="/avatar2.jpg" alt="avatar"
                                            class="w-8 h-8 rounded-full"></a></span>
                    ...
                    <ul class="mb-6 truncate">
                        ...
                        <li class="text-gray-500 px-2 hover:text-gray-200 hover:bg-gray-750 py-1 my-2">
                            <a href="#" class="flex items-center">
                                ...
                                <div class="ml-2">
                                    <div>adamwathan</div>
                                    <div class="text-xxs text-gray-600">Playing <span class="font-bold">Visual
                                            Studio Code</span></div>
                                </div>
                            </a>
                        </li>
                        <li class="text-gray-500 px-2 hover:text-gray-200 hover:bg-gray-750 py-1 my-2">
